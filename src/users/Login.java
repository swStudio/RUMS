...
public class Login extends JFrame
{
	...
	private void createComponent()
	{
		...
		password = new JPasswordField(6);     //密码默认是8位，修改了也只能是八位
	...
	private void setLabelProperty() {	
		labelOfUsername.setBounds(140, 50, 200, 20);
		labelOfPassword.setBounds(140, 85, 200, 20);
	}
	...
	private boolean worningOfCantFindUserInDatabase() throws SQLException {
		...
		else if(!resultset.getString(2).equals(pass) && isLengthOfPasswordLegal())
		{
	...
	private void createDatabaseConnection() throws SQLException {
		...
		String username = "sa";
		String userpass = "";
		String sql = "select userId,userPwd from Users where userId="+"'"+name+"'";
